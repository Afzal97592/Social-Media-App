...
const ForgetPasswordVerificationPage = ({navigation}) => {
  return (
    ...
    >
     ...
     <Text style={formHead3}>A verification code has been sent to your account</Text>
     <TextInput placeholder='Enter 6 digit code here' style={formInput}/>

    <Text
     style={formbtn}
     onPress={()=>navigation.navigate('ForgetPassworNewPasswordPage')}
    >Next</Text>
